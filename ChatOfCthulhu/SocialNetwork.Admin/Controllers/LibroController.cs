...
namespace SocialNetwork.Admin.Controllers
{
    public class LibroController : Controller
    {
        ...
        private string GuardarImagen(HttpPostedFileBase Urlimagen)
        {
            string path = Server.MapPath("~/Imagenes/" + Urlimagen.FileName);
            Urlimagen.SaveAs(path);

            return "/Imagenes/" + Urlimagen.FileName;
        }
    }
}
